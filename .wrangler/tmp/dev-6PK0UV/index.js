...
// .wrangler/tmp/bundle-Y2KHno/checked-fetch.js
        ...
        <div class="row">
            <div class="col-md-12 p-0">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">\u{1F3E0}</a>
...
// src/views/scripts/menu-script.js
var menuScript = `
<script>
...
// src/schema.js
var menus = sqliteTable("menus", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  name: text("name").notNull(),
  status: integer("status").default(1)
});
var greetings = sqliteTable("greetings", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  title: text("title"),
  button_one: text("button_one"),
  button_two: text("button_two")
});
var medias = sqliteTable("medias", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  name: text("name"),
  url: text("url"),
  icon: text("icon"),
...
var about = sqliteTable("about", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  title: text("title"),
  content: text("content")
});
var experience = sqliteTable("experience", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
var achieves = sqliteTable("achieves", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  name: text("name"),
  image: text("image"),
  status: integer("status").default(1)
});
var footers = sqliteTable("footers", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
// .wrangler/tmp/bundle-Y2KHno/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Y2KHno/middleware-loader.entry.ts
